...
final class LocalChunkedAudioRetryStoreTests: XCTestCase {
    ...
    func testStageSaveLoadAndRemoveSession() throws {
        let store = LocalChunkedAudioRetryStore(rootURL: tempDirectoryURL)
        ...
        let snapshot = PersistedLocalChunkedAudioSession(
            ...
            finalizedDraft: PersistedLocalChunkedAudioDraft(
