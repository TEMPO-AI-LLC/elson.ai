...
final class HostedChunkedAudioSessionPartialTests: XCTestCase {
    ...
    func testPartialTranscriptReturnedWhenLaterChunkTimesOut() async throws {
        ...
        let session = HostedChunkedAudioSession(
            ...
            retryStore: HostedChunkedAudioRetryStore(
    ...
    func testNoUsableChunkProducesReplayableFailure() async throws {
        ...
        } catch HostedChunkedAudioSessionError.noUsableTranscript {
        } catch {
