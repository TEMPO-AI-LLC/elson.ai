...
final class AudioRecordingService: NSObject, ObservableObject {
    ...
    private var chunkDuration: TimeInterval = 25
    ...
    func startChunkedRecording(chunkDuration: TimeInterval = 25, onChunk: @escaping (AudioChunk) -> Void) -> Bool {
    ...
    func startChunkedRecording(chunkDuration: TimeInterval = 25, startingIndex: Int, onChunk: @escaping (AudioChunk) -> Void) -> Bool {
        if Thread.isMainThread {
