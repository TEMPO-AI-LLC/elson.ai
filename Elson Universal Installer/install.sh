...
install_app_bundle() {
  ...
  unregister_bundle_if_present "/Applications/${LEGACY_APP_NAME}.app"
  unregister_bundle_if_present "$HOME/Applications/${LEGACY_APP_NAME}.app"
...
unregister_bundle_if_present "/Applications/${LEGACY_APP_NAME}.app"
unregister_bundle_if_present "$HOME/Applications/${LEGACY_APP_NAME}.app"
remove_installed_app_copies "$LEGACY_APP_NAME"
